              	...
              	<a href="{{post.post_link}}" title="{{post.post_title}}">
                    <h3 class="post-title">{{ post.post_title }}</h3>
                  	...
                  	<div>
						...
						<# if(post.terms.post_tag) { #>
                            <div>
                                <p>
                                    ...
                                    <a href="/tag/{{post.terms.post_tag[0].slug}}" title="{{post.terms.post_tag[0].name}}">{{ post.terms.post_tag[0].name }}</a>
                                </p>
                            </div>
                        <# } else { #>
                            <p>
                                <span class="thememattic-icon ion-ios-pricetags-outline"></span>
                                <em><small>Not assigned</small></em>
                            </p>
                        <# } #>
						...
						<p>
                            <span class="thememattic-icon ion-ios-folder-outline"></span>
