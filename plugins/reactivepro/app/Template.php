...
class Template
{
    protected $filter_prefix = 'reactive';

    protected $theme_template_directory = 'reactive';

    protected $plugin_directory = RE_DIR;

    protected $plugin_template_directory = 'reactive-templates';
