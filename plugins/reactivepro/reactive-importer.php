	...
	function process_posts() {
		...
		foreach ( $this->posts as $post ) {
			...
			if ( ! post_type_exists( $post['post_type'] ) ) {
				// start reactive grid template importing
					...
					foreach ($postMeta as $singleMeta) {
						if($singleMeta['key'] == 'reactive_grid_template') {
							$gridMeta = $singleMeta['value'];
						}
					}
					if($gridMeta !== '' || empty($gridMeta)) {
				    ...
				    wp_insert_post( array(
				        ...
				        'post_status'		=> 'publish',
				        'meta_input'    => array(
				        	'reactive_grid_template'	=> $gridMeta,
				        )
				    ) );
				  }
				  // end reactive grid template importing
...
function reactive_importer_init() {
...
add_action( 'admin_init', 'reactive_importer_init' );
