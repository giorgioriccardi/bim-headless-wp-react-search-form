...
if (!function_exists('ssws_enqueue_files')) {
    ...
    {
        wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyB-TU-FquOWVCjo1xZQ7_O0QHqzRjo1Q5g', null, '1.0', true); // don't bother copying this API Key AIzaSyBjDsJj-aXpawLG_MPPZZcpjOYvdoZGsPY, has been cancelled and the new one is restricted!
    }
...
if (!function_exists('sswsGoogleMapKey')) {
    ...
    {
        $api['key'] = 'AIzaSyB-TU-FquOWVCjo1xZQ7_O0QHqzRjo1Q5g'; // don't bother copying this API Key AIzaSyBjDsJj-aXpawLG_MPPZZcpjOYvdoZGsPY, has been cancelled and the new one is restricted!
        return $api;
    }
