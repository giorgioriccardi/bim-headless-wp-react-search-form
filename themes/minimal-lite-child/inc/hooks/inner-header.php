...
<?php $header_image = minimal_lite_get_option('enable_header_overlay', false);
            ...
            ?>
<div class="inner-banner data-bg <?php echo esc_attr($enable_header_image_class); ?> <?php echo esc_attr($header_image_class); ?>"
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <!-- SSWS if naics_code -->
                <?php if (is_tax('naics_code')) { ?>
                <h2>North American Industry Classification System (NAICS)</h2>
                <?php } ?>
                <!-- end SSWS if naics_code -->

                <?php if (is_404()) { ?>
                <h1 class="entry-title"><?php esc_html_e('Oops! That page can&rsquo;t be found.', 'minimal-lite'); ?>
                </h1>
                ...
                <h1 class="entry-title">
                    <?php printf(esc_html__('Search Results for: %s', 'minimal-lite'), '<span>' . get_search_query() . '</span>'); ?>
                </h1>
                <?php } else { ?>
